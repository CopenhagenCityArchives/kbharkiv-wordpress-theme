  ...
  <form role="search" method="get" class="search-form" action="<?php echo e(esc_url( home_url( '/' ) )); ?>">
    ...
    <?php if($field['search_internal_group_link']): ?>
      <div class="d-block mt-4">
        <a href="<?php echo e($field['search_internal_group_link']['url']); ?>" target="<?php echo e($field['search_internal_group_link']['target'] ? $field['search_internal_group_link']['target'] : '_self'); ?>"><?php echo $__env->make('partials.icon', ['icon' => 'arrow-right-circle'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?> <?php echo e($field['search_person_group_link']['title']); ?></a>
      </div>
    <?php endif; ?>
  </form>
</li>
