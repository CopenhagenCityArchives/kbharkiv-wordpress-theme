      ...
      <div class="module-inner">
        ...
        <div class="row">
          ...
          @while ( have_rows('modules_shortcuts_repeater') )
            ...
            <a href="{{ esc_url( $link_url ) }}" target="{{ esc_attr( $link_target ) }}" class="col-sm-6 col-lg-4 d-flex">
              @if( get_sub_field('modules_shortcuts_repeater_icon') )
                @php echo wp_get_attachment_image( get_sub_field('modules_shortcuts_repeater_icon'), 'shortcutx4', true, ['role' => 'presentation'] ) @endphp
              @endif
              <div class="text">
